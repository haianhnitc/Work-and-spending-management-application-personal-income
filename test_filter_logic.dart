...
void testTaskLogic(List<MockTask> tasks, DateTime today, DateTime yesterday,
    DateTime lastWeek) {
...
void testExpenseLogic(List<MockExpense> expenses, DateTime today,
    DateTime yesterday, DateTime lastWeek) {
  print('\n\n🔹 EXPENSE LOGIC TESTING');

  // Test Case 1: Không có filter gì cả
  print('\n1️⃣ NO FILTERS:');
  var categoryTotals =
      computeExpenseCategoryTotals(expenses, '', (date) => true);
  print('   Result: $categoryTotals');
  ...
  categoryTotals =
      computeExpenseCategoryTotals(expenses, 'food', (date) => true);
  print('   Result: $categoryTotals');
  ...
  categoryTotals = computeExpenseCategoryTotals(
      expenses,
      'food',
      (date) =>
          date.day == today.day &&
...
Map<String, int> computeTaskCategoryTotals(
    List<MockTask> tasks, String selectedCategory, String searchQuery) {
...
Map<String, double> computeExpenseCategoryTotals(List<MockExpense> expenses,
    String selectedCategory, bool Function(DateTime) filterByTime) {
